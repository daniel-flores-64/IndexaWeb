<?php
  ...
  */
  ...
  if ( class_exists( 'KEYDESIGN_ADDON_CLASS' ) && class_exists( 'ReduxFramework' ) ) {
    Redux::setExtensions( 'redux_ThemeTek', WP_PLUGIN_DIR . '/keydesign-addon/extensions/' );
  }
  ...
  Redux::setSection( $opt_name, array(
      ...
      'fields' => array(
        array(
            ...
            'type' => 'switch',
            'title' => esc_html__('Enable Custom Fonts', 'ekko'),
            'default' => false
        ),
        array(
  ...
  Redux::setSection( $opt_name, array(
      ...
      'fields' => array(
        ...
        array(
            ...
            'type' => 'button_set',
            'title' => esc_html__('Displayed Date', 'ekko'),
            'subtitle' => esc_html__('Display published or last updated date for blog posts.', 'ekko'),
            'select2' => array('allowClear' => false, 'minimumResultsForSearch' => '-1'),
            'options'  => array(
  ...
  Redux::setSection( $opt_name, array(
      ...
      'title' => esc_html__('FAQ', 'ekko'),
      'desc' => esc_html__('FAQ general settings.', 'ekko'),
      'subsection' => true,
      'fields' => array(
        array(
          'id' => 'tek-faq-collapsible',
          'type' => 'switch',
          'title' => esc_html__('Auto collapse', 'ekko'),
          'subtitle' => esc_html__('Auto collapse expanded FAQ when clicking another element of the same type. Only one item will remain expanded at any point.', 'ekko'),
          'default' => false
        ),
      )
  ) );
