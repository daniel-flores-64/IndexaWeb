...
$transparent_navigation = get_post_meta( get_the_ID(), '_themetek_page_transparent_navbar', true );
$transparent_navigation_color = get_post_meta( get_the_ID(), '_themetek_page_transparent_menu_link_color', true );
?>
...
@media (min-width: 960px) {
	...
	.transparent-navigation #logo .logo {
		...
		<?php elseif ( ekko_get_option( 'tek-transparent-homepage-menu-colors' ) ) : ?>
...
<?php
	...
	.navbar-default.navbar-shrink #main-menu .navbar-nav .menu-item-has-children .dropdown-menu a,
...
<?php if ( ekko_get_option( 'tek-header-menu-color-hover' ) ) : ?>
	.navbar-default .nav:hover > li.dropdown:hover > a,
	.navbar.navbar-default .menubar .navbar-nav .active > a,
	.navbar-default .menubar #main-menu .navbar-nav .mega-menu.menu-item-has-children .dropdown:hover > a,
...
<?php if ( ekko_get_option( 'tek-header-menu-color-sticky-hover' ) && ekko_get_option( 'tek-menu-behaviour' ) == '1' ) : ?>
	...
	.navbar.navbar-default.navbar-shrink .menubar .navbar-nav .active > a,
	.navbar.navbar-default.navbar-shrink #main-menu .navbar-nav .active > a,
	.navbar-default.navbar-shrink .nav:hover > li.dropdown:hover > a,
	.navbar.navbar-default.navbar-shrink .menubar .navbar-nav a:hover,
	.navbar-default.navbar-shrink #main-menu .navbar-nav .menu-item-has-children .dropdown-menu a:hover,
	.navbar-default.navbar-shrink.menu-item-has-children .dropdown-menu a:hover,
	.body:not(.transparent-navigation) .navbar-default.navbar-shrink a:hover,
	.navbar-default.navbar-shrink .nav li.active a {
		color: <?php echo esc_attr( ekko_get_option( 'tek-header-menu-color-sticky-hover' ) ); ?> !important;
	}
<?php endif; ?>

<?php if ( ekko_get_option( 'tek-header-menu-color-sticky-hover' ) ) : ?>
.navbar-shrink #main-menu.background-dropdown-effect .navbar-nav .menu-item-has-children .dropdown-menu a:hover,
.navbar-shrink #main-menu.underline-effect .navbar-nav .mega-menu .dropdown-menu .menu-item a:after,
.navbar-shrink #main-menu.underline-effect .navbar-nav .menu-item .dropdown-menu .menu-item a:after {
	background: <?php echo esc_attr( ekko_get_option( 'tek-header-menu-color-sticky-hover' ) ); ?> !important;
}
<?php endif; ?>
...
<?php  if ( ekko_get_option( 'tek-default-typo' ) ) : ?>
	body, .box, .cb-text-area p, body p , .upper-footer .search-form .search-field, .upper-footer select, .footer_widget .wpml-ls-legacy-dropdown a, .footer_widget .wpml-ls-legacy-dropdown-click a {
		...
		<?php endif; ?>
		<?php if ( isset( $default_typo['letter-spacing'] ) && '' != $default_typo['letter-spacing'] ): ?>
			letter-spacing: <?php echo esc_attr( $default_typo['letter-spacing'] ); ?>;
		<?php endif; ?>
	}
...
<?php  if ( ekko_get_option( 'tek-heading-typekit-selector' ) ) : ?>
	.container h1, .container h2, .container h3, .pricing .col-lg-3, .chart, h2.blog-single-title a, .pb_counter_number, .pc_percent_container, #logo .logo {
...
<?php if (  ekko_get_option( 'tek-custom-fonts-switch' ) ) : ?>
