 ...
 */
define( 'AYS_PB_NAME_VERSION', '3.0.0' );
             ...
             <div class="ays-notice-banner ays-pb-notice">
                <div class="navigation-bar">
                    <div id="navigation-container">
                        ...
                        <ul id="menu">
                            <li class="modile-ddmenu-xss"><i class="ays_fa ays_fa_diamond ays-fa-margin-right" style="color:#5561A3;font-size: 14px;"></i><a class="ays-btn" href="https://ays-pro.com/wordpress/popup-box" target="_blank">PRO</a></li>
