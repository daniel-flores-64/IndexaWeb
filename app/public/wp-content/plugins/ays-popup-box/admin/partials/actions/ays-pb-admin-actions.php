        ...
        <form method="post" name="popup_attributes" id="ays_pb_form">
                ...
                <div class="form-group row">
                    <div class="col-sm-3">
                        <label for="<?php echo $this->plugin_name; ?>-popup_title">
                            ...
                            <a class="ays_help" data-toggle="tooltip"
                               title="<?php echo __('Define the popup title. You can either display or hide the title in the settings tab.', $this->plugin_name) ?>">
                                <i class="ays_fa ays_fa-info-circle"></i>
                            </a>
                        </label>
                    </div>
                ...
                <div class="form-group row" id="ays_shortcode" style="display: none;">
                    <div class="col-sm-3">
                        <label for="<?php echo $this->plugin_name; ?>-shortcode">
                            ...
                            <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Copy and paste the shortcode created with other plugins (E.g. Contact form, Subscribe, Login, Poll, Survey, Quiz, etc).', $this->plugin_name); ?>">
                               <i class="ays_fa ays_fa-info-circle"></i>
                            </a>
                        </label>
                    </div>
                ...
                <div class="form-group row ays-field">
                    <div class="col-sm-3">
                        <label for="<?php echo $this->plugin_name; ?>-popup_description">
                            ...
                            <a class="ays_help" data-toggle="tooltip" title="<?php echo __("Provide more information about the popup. It will be shown below the title. You can either display or hide the description in the settings tab.", $this->plugin_name); ?>">
                                <i class="ays_fa ays_fa-info-circle"></i>
                            </a>
                        </label>
                    </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-3">
                        <label for="<?php echo $this->plugin_name; ?>-action_button_type">
                            <span> <?php echo __('Popup trigger', $this->plugin_name); ?></span>
                                <a class="ays_help" data-toggle="tooltip" data-html="true"
                                title="<?php
                                    echo __('Choose the trigger causing the popup to open on certain events.',$this->plugin_name) .
                                    "<ul style='list-style-type: circle;padding-left: 20px;'>".
                                        "<li>". __('Onload - trigger displays the popup automatically on the page load. Define the time delay of the popup in “Open Delay” option.',$this->plugin_name) ."</li>".
                                        "<li>". __('Onclick - Trigger displays a popup on your site when the user clicks on a targeted CSS element(s). Define the CSS element in the “CSS selector(s)” option.',$this->plugin_name) ."</li>".
                    ...
                    <div class="col-sm-9">
                        <select id="<?php echo $this->plugin_name; ?>-action_button_type" class="ays-text-input" name="<?php echo $this->plugin_name; ?>[action_button_type]">
                            ...
                            <option <?php echo 'clickSelector' == $action_button_type ? 'selected' : ''; ?> value="clickSelector"><?php echo __('Onclick'); ?></option>
                            <option value="exit_intent" disabled><?php echo __('Exit Intent (Pro)'); ?></option>
                        </select>
                        <span style="display:block;" class="ays-pb-small-hint-text" ><a href="https://youtu.be/YTB5_J74AIg" target="_blank"><?php echo __("View how to make popup on button click", $this->plugin_name);?></a></span>
                    </div>
                </div>
                <hr/>
                <div class="form-group row">
            ...
            <div id="tab2" class="ays-pb-tab-content  <?php echo ($ays_pb_tab == 'tab2') ? 'ays-pb-tab-content-active' : ''; ?>">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="form-group row" style="padding:10px;">
                        ...
                        <div class="col-sm-8 ays_divider_left">
                            <input type="text" id="ays_pb_popup_name" name="ays_pb_popup_name" class="ays-text-input ays-pb-popup-name" value="">
                        </div>
                    </div> <!-- Popup Name -->
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="number" class="ays-text-input ays-text-input-short" id='ays_pb_create_author'name='ays_pb_create_author' value="<?php echo $change_pb_create_author; ?>"/>
                    </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-3">
                         <label for="ays_pb_disable_scroll">
                            ...
                            <a class="ays_help" data-toggle="tooltip" title="<?php echo __("Prevent the page from scrolling when a popup is opened.", $this->plugin_name); ?>">
                                <i class="ays_fa ays_fa-info-circle"></i>
                            </a>
                        </label>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9 row ays_toggle_parent">
                        <div class="col-sm-3">
                            <input type="checkbox" name="ays_pb_enable_dismiss" class="ays_toggle_checkbox onoffswitch-checkbox" id="ays_pb_enable_dismiss" <?php echo ($enable_dismiss) ? 'checked' : ''; ?> />
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 ays_divider_left">
                                <input type="number" id="ays_pb_mobile_height"  class="ays-text-input-short ays-pb-mobile-height" name="ays_pb_mobile_height" value="<?php echo $mobile_height; ?>"/>
                            </div>
                        </div>
                        <hr>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 ays_divider_left">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" id="ays_pb_font_size_for_pc" class="ays-text-input-short" name="ays_pb_font_size" value="<?php echo $pb_font_size;?>"/>
                                    </div>
                                </div>
                                <hr>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" id="ays_pb_font_size_for_mobile" class="ays-text-input-short" name="ays_pb_font_size_for_mobile" value="<?php echo $pb_font_size_for_mobile;?>"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-sm-7 ays_divider_left">
                                    ...
                                    <div class="row ays_toggle_target" style="margin: 10px 0 0 0; padding-top: 10px;">
                                        <div class="col-sm-12 ays_divider_top row" style="margin-top: 10px; padding-top: 10px;">
                                            ...
                                            <div class="col-sm-7 ays_divider_left">
                                                <select name="title_font_family" id="ays_title_font_family" class="ays-text-input-max-width-100">
                                                    <option>
                                        ...
                                        <div class="col-sm-12 ays_divider_top row" style="margin-top: 10px; padding-top: 10px;">
                                            ...
                                            <div class="col-sm-7 ays_divider_left">
                                                <select name="title_font_weight" id="ays_title_font_weight" class="ays-text-input-max-width-100">
                                                    <option>
                                        ...
                                        <div class="col-sm-12 ays_divider_top row" style="margin-top: 10px; padding-top: 10px;">
                                            ...
                                            <div class="col-sm-7 ays_divider_left">
                                                <select name="title_text_alignment" id="ays_title_text_alignment" class="ays-text-input-max-width-100">
                                                    <option>
                                        ...
                                        <div class="col-sm-12 ays_divider_top row" style="margin-top: 10px; padding-top: 10px;">
                                            ...
                                            <div class="col-sm-7 ays_divider_left">
                                                <select name="title_text_transform" id="ays_title_text_transform" class="ays-text-input-max-width-100">
                                                    <option>
                                        ...
                                        <div class="col-sm-12 ays_divider_top row" style="margin-top: 10px; padding-top: 10px;">
                                            ...
                                            <div class="col-sm-7 ays_divider_left">
                                                <select name="title_text_decoration" id="ays_title_text_decoration" class="ays-text-input-max-width-100">
                                                    <option>
                                                        <?php echo __('None', $this->plugin_name); ?>
                                                    </option>
                                                </select>
                        ...
                        <div class="col-sm-12">
                            ...
                            <!-- Buttons Size start-->
                            <div class="form-group" id="ays_pb_button_size_content">
                                <div class="form-group row">
                                    <div class="col-sm-5">
                                    ...
                                    <div class="col-sm-7 ays_divider_left">
                                        <select class="ays-text-input ays-text-input-short" id="ays_pb_buttons_size" name="ays_pb_buttons_size">
                                            <option value="small">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7 ays_divider_left">
                                        <input type="number" class="ays-text-input ays-text-input-short" id='ays_pb_buttons_font_size'name='ays_pb_buttons_font_size' value="17"/>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7 ays_divider_left">
                                        <input type="number" class="ays-text-input ays-text-input-short" id='ays_pb_buttons_width'name='ays_pb_buttons_width' value="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7 ays_divider_left">
                                        <input type="number" class="ays-text-input ays-text-input-short" id="ays_pb_buttons_border_radius" name="ays_pb_buttons_border_radius" value="3"/>
                                    </div>
