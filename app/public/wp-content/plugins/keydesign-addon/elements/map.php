...
if (!class_exists('KD_ELEM_MAP')) {
    class KD_ELEM_MAP extends KEYDESIGN_ADDON_CLASS {
        ...
        public function kd_map_shrt($atts, $content = null) {
            ...
            // Declare empty vars
            $output = $gmap_style_var = $business_data = $business_phone = $content_image = $map_img_array = '';
            ...
            $output .= '<div class="kd-alertbox kd-contact-alertbox ab_info kd_map_alert">
                  ...
                  if ( $map_business_panel_settings != "hidden_info_panel" && '' != $map_business_phone ) {
                    $business_phone = str_replace(' ', '', $map_business_phone );
                  }
                        ...
                        <div class="business-info-header">';
                            ...
                            $output .= '<address>';
                              ...
                              if ( $map_business_phone != '' ) {
                                  $output .= '<span class="business-phone-row"><i class="fas fa-phone-alt"></i><a href="tel:'.$business_phone.'">'.$map_business_phone.'</a></span>';
                              }
