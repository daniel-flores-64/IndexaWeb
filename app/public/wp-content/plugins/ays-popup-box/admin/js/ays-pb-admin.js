    ...
    $(document).ready(function (){
      ...
      setTimeout(function(){
        ...
        $('.ays-pb-template-overlay-preview').hover(
            function() {
                $(this).find('div.ays-pb-choose-template-div').fadeIn("slow");
            },
            function() {
                ...
                if(checkedTheme){
                    ...
                    $(this).find('div.ays-pb-choose-template-div').fadeOut("slow");
                }
            }
        );

        $(document).on('click', '.ays-pb-template-choose-template-btn', function(){
