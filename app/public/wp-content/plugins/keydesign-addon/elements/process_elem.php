...
if (!class_exists('tek_process')) {
    class tek_process extends KEYDESIGN_ADDON_CLASS
    {
        ...
        public function kd_process_single($atts, $content = null) {
            ...
            $output = '
                <li class="pss-item '.$css_animation.' '.$pss_extra_class.'" '.(!empty($pss_custom_style) ? 'style="' . $pss_custom_style . '"' : '').' '.$animation_delay.'>
                        ...
                        $output .= '<div class="pss-text-area">
                            ...
                            if( $pss_custom_link == "1" ) {
                              if ( $button_action == "modal-trigger-btn" ) {
                                $output .= '<a class="tt_button '.$pss_button_style.' '.$pss_button_color_scheme.'" data-toggle="modal" data-target="#popup-modal">'.$pss_link_text.'</a>';
                              } elseif ( $button_action == "panel-trigger-btn" ) {
                                $output .= '<a class="tt_button '.$pss_button_style.' '.$pss_button_color_scheme.' '.$button_action.'">'.$pss_link_text.'</a>';
                              } else {
                                $output .= '<a href="'.$href['url'].'" class="tt_button '.$pss_button_style.' '.$pss_button_color_scheme.'" '.$link_target.''.$link_title.'>'.$pss_link_text.'</a>';
                              }
                            }
                        $output .= '</div>
                    </div>
