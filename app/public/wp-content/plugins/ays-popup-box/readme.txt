...
* **Send file after subscription** - The website visitors can receive files via email right after the subscription.
...
Create newsletter subscription forms and collect your target audience for the next marketing campaign. Impressive, right? Moreover, you can add popup video, yes no popup, iframe elements and so much more using this modal survey plugin.

You can have an unlimited number of popups on your website and there can be different popups on different pages of your website. Use pop-up custom HTML and add new opportunities to your WordPress modal. Other benefits are animation effects and you can have your favorite popup animation effect. And one more great thing! You control every single feature taking into account what you and your website visitors want! This Popup maker plugin is free for a lifetime and comfortable for usage.
...
All these points are available with our popup builder. Display pop up with this popup plugin in wordpress.
...
In case of any questions and suggestions, feel free to open a new topic on WordPress.org, or contact us via e-mail info@ays-pro.com.
